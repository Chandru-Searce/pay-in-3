...
def _ad_campaign_generator_function(
    ...
    destination_blob_with_text = (
        f"ad_campaigns/{timestamp}_{uuid.uuid4().hex[:8]}_with_text.png"
    )
    ...
    destination_blob_without_text = (
        f"ad_campaigns/{timestamp}_{uuid.uuid4().hex[:8]}_without_text.png"
    )
